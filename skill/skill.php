    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <aside class="w-full lg:w-64 bg-white dark:bg-gray-800 shadow-md">
            ...
            <nav class="p-6 space-y-4">
                <a href="../divisi/divisi.php?cabang_id=<?= $cabang_id ?>" class="flex items-center text-gray-700 dark:text-gray-300 px-4 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group">
                ...
                <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <a href="../staff/staff.php?divisi_id=<?= $divisi_id ?>" class="flex items-center text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                <div>
                    <div class="flex items-center space-x-3">
                        <h1 class="text-3xl font-bold text-gray-800 dark:text-white"><?= htmlspecialchars($divisi_name) ?></h1>
            ...
            <?php if ($result->num_rows > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    ?>
                        <div class="skill-card p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 flex flex-col">
                            <div class="flex items-start justify-between">
                                <div>
                                    ...
                                    <div class="flex items-center mt-2">
                                        <span class="bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-300 text-sm font-medium px-2.5 py-0.5 rounded-full flex items-center">
                                ...
                                <div class="dropdown relative">
                                    ...
                                    <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-10">
                                        <a href="edit_skill.php?id=<?= $skill['id_skill'] ?>&divisi_id=<?= $divisi_id ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <i class="fas fa-edit mr-2"></i> Edit
                                        </a>
                                        <a href="hapus_skill.php?id=<?= $skill['id_skill'] ?>&divisi_id=<?= $divisi_id ?>" onclick="return confirm('Anda yakin ingin menghapus skill ini?')" 
            ...
            <?php else: ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center border border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-medium text-gray-800 dark:text-white mb-2">Belum ada skill yang terdaftar</h3>
