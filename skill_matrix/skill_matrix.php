...
<body class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <aside class="w-full lg:w-64 bg-white dark:bg-gray-800 shadow-md">
            ...
            <nav class="p-6 space-y-4">
                ...
                <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                    <h3 class="text-sm uppercase text-gray-500 dark:text-gray-400 font-semibold mb-3">Navigasi Cepat</h3>
                    <a href="../index.php" class="flex items-center text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group">
                        <i class="fas fa-home mr-3 text-gray-500 dark:text-gray-400 group-hover:text-primary-500"></i>
                        <span>Home</span>
                    </a>
                    <a href="#" class="flex items-center text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition group">
        ...
        <main class="flex-1 p-6 lg:p-8 overflow-x-auto">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-white mb-2">
                        Skill Matrix: <span class="text-primary-600 dark:text-primary-400"><?php echo htmlspecialchars($skill_name); ?></span>
                    </h1>
                    <div class="flex flex-col sm:flex-row sm:items-center text-sm text-gray-600 dark:text-gray-400 mt-1">
            ...
            <div id="successAlert" class="fixed top-4 right-4 bg-green-100 dark:bg-green-900 border-l-4 border-green-500 text-green-700 dark:text-green-300 p-4 rounded shadow-md z-50 animate-fade-in-out">
                <div class="flex items-center">
                ...
                <form method="post" action="">
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead>
                                <tr>
                                    <th rowspan="2" class="px-6 py-3 bg-gray-50 dark:bg-gray-700 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-600 sticky left-0 z-10">
                                        <div class="flex items-center">
                                            <i class="fas fa-user mr-2 text-primary-500"></i>
                                            Nama Staff
                                        </div>
                                    </th>
                                    <th colspan="6" class="px-6 py-3 bg-gray-50 dark:bg-gray-700 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-600">
                                        Kriteria Penilaian
                                    </th>
                                </tr>
                                <tr class="bg-gray-50 dark:bg-gray-700">
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider border-b border-gray-200 dark:border-gray-600 w-28">
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                ?>
                                        <tr class="<?php echo $bg_class; ?> hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                            <td class="px-6 py-4 whitespace-nowrap sticky left-0 <?php echo $bg_class; ?> z-10">
                                                <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo htmlspecialchars($staff['nama_staff']); ?></div>
                                            </td>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-center">
                                                <div class="bg-gray-100 dark:bg-gray-600 w-16 h-10 rounded-md border border-gray-300 dark:border-gray-500 flex items-center justify-center text-center mx-auto">
